...
const regex2let = /\b(?:BI|BS|BL|CB|CG|CT|CW|DJ|DL|DB|DW|EP|ES|EL|FG|FZ|GD|GA|GSP|GS|KR|KK|KN|KT|LB|LC|LU|LZ|NE|NO|OP|PK|PN|PL|PO|PY|RK|RP|RZ|RT|SB|SY|SH|SC|SD|SG|SJZ|SJ|SK|SM|SPI|SL|SR|SI|SO|SW|ST|SZ|SZO|TK|WO|WA|WP|WI|WR|WS|ZK|ZSW|ZS|ZZ|XD)\b/
...
class VisionService {
    ...
    static async detectPlates(images, mode = 0) {
        const client = new vision.ImageAnnotatorClient({
            keyFilename: "./src/config/VISION_API_KEY.json",
        });
